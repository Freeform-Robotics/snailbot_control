...
extern void BMI088_accel_read_over(const uint8_t *rx_buf, float accel[3]);
extern void BMI088_gyro_read_over(const uint8_t *rx_buf, float gyro[3]);
...
extern float get_BMI088_temperature(void);
extern void get_BMI088_gyro_raw(uint8_t gyro[6]);
extern void get_BMI088_gyro(float gyro[3]);
